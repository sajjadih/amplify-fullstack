  ...
  return (
    ...
    >
      <View
        ...
        left="10.42%"
        right="10.42%"
        {...getOverrideProps(overrides, "Iconly/Bold/Setting")}
      >
        <View
          padding="0px 0px 0px 0px"
          width="38px"
